...
const ResetPasswordForm = ({status, user, error, handleChange, handleResetPassword, showPassword, handleShowPassword, showConfirmPassword, handleShowConfirmPassword}) => {
...
return (
    <>
        ...
        <form className='w-full text-sm font-Montserrat text-my-primary' onSubmit={handleResetPassword}>
            ...
            <div className='relative mt-3'>
                <label> Confirm Password  <span className='text-crimson'> * </span></label> <br />
                <input 
