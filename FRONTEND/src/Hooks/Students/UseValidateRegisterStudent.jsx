...
const UsevalidateRegisterStudent = (value) => {
    ...
    const validate = (value) => {
        ...
        for (const field in value) {
            ...
            else if (field === 'status' && value[field].trim() === '') {
                newErrors[field] = 'Student status is required';
            }
            else if (field === 'session' && value[field].trim() === '') {
                newErrors[field] = 'Session is required';
            }
...
export default UsevalidateRegisterStudent